    ...
    <center>
		...
		<form action="crear.php" method="POST">
            ...
            <div class="form-group row">
                ...
                <label class="col-sm-1 col-form-label">Contraseña:</label>
                <div class="col-md-5">
					<input name="confirm_password" class="form-control" type="password" placeholder="Confirmar contraseña"> <br>
				</div>
            </div>
			<input class="btn btn-primary" type="submit" value="Crear Sesión">
		</form>
    </center>
  </body>
