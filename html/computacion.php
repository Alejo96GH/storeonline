...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <script type="text/javascript" src="js/scriptsComputador.js"></script>
  ...
  <body>
    ...
    <center><h2>Computación</h2></center><br>
        ...
        <div class="col-9 ">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_1">
                       <center><img src="../img/p1.jpg" height="60%" width="60%"></center><p>Portatil Hp Gamer I5-9300h 1tera 8ram Nvidia Gtx1050 15.6fhd</p><u><i>Precio: $2.689.900</i></u><br> 
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_2">
                       <center><img src="../img/p3.jpg" height="70%" width="70%"></center><p>Portatil Asus X509f Core I7 8565u 512gb Ssd +20gb Tv Mx110</p><u><i>Precio: $2.899.900</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button>  
                    </div>        
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_3">
                       <center><img src="../img/p2.jpg" height="80%" width="80%"></center><p>Portátil Asus X512fb- Core I5-12gb Ram 512gb Ssd -mx110(2gb)</p><u><i>Precio: $2.519.900</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button> 
                    </div>          
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_4">
                       <center><img src="../img/p4.jpg" height="80%" width="80%"></center><p>Portátil Asus X509ua-br264-core I3-7020u-4gb -256gb-endless</p><u><i>Precio: $1.399.900</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button>    
                    </div>       
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_5">
                       <center><img src="../img/p5.jpg" height="60%" width="60%"></center><p>Computador Portátil Lenovo 14 Pulgadas Ci5 4Gb 256Gb</p><u><i>Precio: $1.763.370</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button> 
                    </div>          
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_6">
                       <center><img src="../img/p6.jpg" height="70%" width="70%"></center><p>Computador Portátil HP 14 Pulgadas Ci3 8Gb 256Gb SSD</p><u><i>Precio: $1.684.260</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button>  
                    </div>        
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_7">
                       <center><img src="../img/p7.jpg" height="80%" width="80%"></center><p>Computador Portátil HP Convertible ENVY x360</p><u><i>Precio: $3.101.340</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button> 
                    </div>          
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_8">
                       <center><img src="../img/p8.jpg" height="80%" width="80%"></center><p>Computador Portátil Lenovo 14 Pulgadas Ci5 8Gb 512Gb</p><u><i>Precio: $2.609.130</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button>    
                    </div>       
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_9">
                       <center><img src="../img/p9.jpg" height="60%" width="60%"></center><p>Computador Portátil Lenovo R3 Renoir 8GB 512GB SSD</p><u><i>Precio: $1.775.260</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button> 
                    </div>          
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_10">
                       <center><img src="../img/p10.jpg" height="70%" width="70%"></center><p>Computador Portátil HP 15.6 Pulgadas Ci5 </p><u><i>Precio: $3.081.094</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button>  
                    </div>        
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_11">
                       <center><img src="../img/p11.jpg" height="80%" width="80%"></center><p>Computador Portatil HP 15.6 Pulgadas Core i5 8Gb 1Tb 15</p><u><i>Precio: $2.276.936</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button> 
                    </div>          
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                	<div id="contenidos_12">
                       <center><img src="../img/p12.jpg" height="80%" width="80%"></center><p>Computador Portátil Acer Gaming Ci5 8Gb 1Tb + Mouse + Headset AN515</p><u><i>Precio: $3.359.160</i></u><br> 
                       <button class="btn btn-success" type="submit">Comprar</button>    
                    </div>       
                </div>
